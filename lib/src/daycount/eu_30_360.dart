...
/// immediately following the last day included in the Calculation Period or
...
class EU30360 extends Convention {
  ...
  /// first and subsequent cash flow dates using *actual days*, whereas this
  /// implementation offers the flexibility to determine those time intervals
