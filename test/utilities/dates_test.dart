...
void main() {
  group('actualDays', () {
    ...
    test('01/02/2019 to 02/02/2019', () {
      expect(
        actualDays(DateTime.utc(2019, 2, 1), DateTime.utc(2019, 2, 2)),
        1,
      );
    });
    test('01/02/2019 to 01/02/2019', () {
      expect(
        actualDays(DateTime.utc(2019, 2, 1), DateTime.utc(2019, 2, 1)),
        0,
      );
    });
  ...
  group('hasLeapYear', () {
    ...
    test('2001 to 2000 to return false as year from post-dates year to', () {
      expect(hasLeapYear(2001, 2000), false);
    });
    test('2000 to 2000 to return true', () {
      expect(hasLeapYear(2000, 2000), true);
    });
    test('2017 to 2021 to return true for year 2020', () {
      expect(hasLeapYear(2017, 2020), true);
    });
  });
  ...
  group('rollDay', () {
    test('Leap-year', () {
      expect(
        rollDay(DateTime.utc(2020, 3, 1), -1),
        DateTime.utc(2020, 2, 29),
      );
    });
    test('Non leap-year', () {
      expect(
        rollDay(DateTime.utc(2019, 3, 1), -1),
