...
void main() {
  group('US30360', () {
    ...
    test('28/01/2020 to 29/02/2020 (leap year, no special adjustment)', () {
    ...
    test(
      '28/02/2020 to 31/03/2020 (D1 = 28 < 30, D2 = 31 -> no adjustment)',
      () {
        final factor = dc.computeFactor(
        ...
        // D1 = 28, D2 = 31 -> 33 days
        expect(factor.primaryPeriodFraction, closeTo(33 / 360, 1e-10));
        expect(factor.toString(), 'f = 33/360 = 0.09166667');
        expect(factor.toFoldedString(), 'f = 33/360 = 0.09166667');
      },
    );

    test('31/12/2017 to 31/12/2019 (multi-year exact)', () {
      final factor = dc.computeFactor(
    ...
    group('with useXirrMethod: true', () {
      const dcXirr = US30360(useXirrMethod: true);
