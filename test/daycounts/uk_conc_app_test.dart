...
void main() {
  group('UKConcApp - secured (App 1.1), monthly', () {
    ...
    test('31/01/2025 -> 28/02/2029 (multiple years)', () {
      ...
      expect(factor.toString(), 'f = 73/12 = 6.08333333');
      expect(factor.toFoldedString(), 'f = 6 + 1/12 = 6.08333333');
    });
    ...
    test('12/01/2025 -> 15/02/2025 (1 whole month + 3 residual days)', () {
      ...
      expect(factor.toString(), 'f = 1/12 + 3/365 = 0.09155251');
      expect(factor.toFoldedString(), 'f = 1/12 + 3/365 = 0.09155251');
    });
  ...
  group('UKConcApp - secured (App 1.1), weekly', () {
    ...
    test('01/01/2020 -> 22/01/2020 (exactly 3 weeks)', () {
      ...
      expect(factor.toString(), 'f = 3/52 = 0.05769231');
      expect(factor.toFoldedString(), 'f = 3/52 = 0.05769231');
    });
    test('01/01/2020 -> 29/01/2020 (exactly 4 weeks)', () {
      ...
      expect(factor.toString(), 'f = 4/52 = 0.07692308');
      expect(factor.toFoldedString(), 'f = 4/52 = 0.07692308');
    });
    test('01/01/2020 -> 23/01/2020 (3 weeks + 1 day residual)', () {
      ...
      expect(factor.toString(), 'f = 3/52 + 1/366 = 0.06042455');
      expect(factor.toFoldedString(), 'f = 3/52 + 1/366 = 0.06042455');
    });
  });
  group(
  ...
  group('UKConcApp - non-secured (App 1.2), monthly', () {
    ...
    test('15/12/2023 --> 29/02/2024 (cross-year, leap)', () {
      ...
      expect(factor.toString(), 'f = 2/12 + 14/366 = 0.20491803');
    });
    test('20/11/2023 --> 15/01/2024 (remaining days cross-year, leap)', () {
      ...
      expect(factor.toString(), 'f = 1/12 + 11/365 + 14/366 = 0.15172169');
    });
  });
  ...
  group('UKConcApp - non-secured (App 1.2), weekly', () {
    ...
    test('01/01/2023 --> 14/01/2024 (whole weeks, cross-year)', () {
      ...
      expect(factor.toString(), 'f = 54/52 = 1.03846154');
      expect(factor.toFoldedString(), 'f = 1 + 2/52 = 1.03846154');
    });
    test('12/01/2024 --> 30/01/2024 (non-whole)', () {
      ...
      expect(factor.toString(), 'f = 2/52 + 4/366 = 0.04939050');
    });
    test('02/12/2023 --> 05/01/2024 (remaining days cross-year, leap)', () {
      ...
      expect(factor.toString(), 'f = 4/52 + 1/365 + 4/366 = 0.09059176');
    });
  });
