  ...
  group('US30U360', () {
    ...
    test(
      ...
      () {
        ...
        expect(factor.toString(), 'f = 32/360 = 0.08888889');
        expect(factor.toFoldedString(), 'f = 32/360 = 0.08888889');
      },
    );
    ...
    test('01/01/2018 to 01/01/2020 (multi-year exact)', () {
      ...
      expect(factor.toString(), 'f = 2 = 2.00000000');
    ...
    test('15/12/2023 --> 29/02/2024 (cross-year, leap)', () {
      ...
      expect(factor.toString(), 'f = 75/360 = 0.20833333');
      expect(factor.toFoldedString(), 'f = 75/360 = 0.20833333');
    });
    test('28/02/2023 --> 29/02/2024 (non-leap -> leap, Feb ends)', () {
      ...
      expect(factor.toString(), 'f = 1 = 1.00000000');
