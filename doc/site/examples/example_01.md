...
This example illustrates the use of one of two [Modes](https://andrewmurphy353.github.io/curo/api/curo/Mode.html), a core concept in financial calculations, when solving for unknowns. 
...
This example solves for an unknown instalment amount for a $10,000 loan over six months, the default [Frequency](https://andrewmurphy353.github.io/curo/api/curo/Frequency.html) if not defined.
